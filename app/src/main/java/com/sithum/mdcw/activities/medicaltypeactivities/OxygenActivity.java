...
import com.sithum.R;
import com.sithum.mdcw.fragments.OxygenNewFragment;
import com.sithum.mdcw.fragments.OxygenPreFragment;
...
public class OxygenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new OxygenNewFragment());

        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new OxygenPreFragment());
            }
        });
