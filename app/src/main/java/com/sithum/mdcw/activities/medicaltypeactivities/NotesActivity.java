...
import com.sithum.R;
import com.sithum.mdcw.fragments.NotesNewFragment;
import com.sithum.mdcw.fragments.NotesPreFragment;
...
public class NotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new NotesNewFragment());

        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new NotesPreFragment());
            }
        });
