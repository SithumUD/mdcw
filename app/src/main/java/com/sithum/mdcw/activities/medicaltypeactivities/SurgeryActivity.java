...
import com.sithum.R;
import com.sithum.mdcw.fragments.SurgeryNewFragment;
import com.sithum.mdcw.fragments.SurgeryPreFragment;
...
public class SurgeryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new SurgeryNewFragment());

        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new SurgeryPreFragment());
            }
        });
