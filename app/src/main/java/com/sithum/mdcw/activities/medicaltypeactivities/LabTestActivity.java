...
import com.sithum.R;
import com.sithum.mdcw.fragments.LabTestNewFragment;
import com.sithum.mdcw.fragments.LabTestPreFragment;
...
public class LabTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new LabTestNewFragment());

        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new LabTestPreFragment());
            }
        });
