...
import com.sithum.R;
import com.sithum.mdcw.fragments.InjuriesNewFragment;
import com.sithum.mdcw.fragments.InjuriesPreFragment;
...
public class InjuriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new InjuriesNewFragment());

        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new InjuriesPreFragment());
            }
        });
